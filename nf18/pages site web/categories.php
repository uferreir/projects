...
$query = "SELECT Livre.nom as ln, Auteur.nom as an, Auteur.prénom as ap, date_parution,résumé, lien_contenu FROM Livre LEFT JOIN Ecrit ON Livre.lien_contenu=Ecrit.livre RIGHT JOIN Auteur ON Auteur.id=Ecrit.auteur Where Livre.catégorie='$var'";
